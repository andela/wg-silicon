...
@task(
    help={
        ...
        'settings-path':
        'Path to settings file (absolute path recommended). Leave empty for '
        'default',
        'extra-args':
...
@task(
    help={
        'settings-path':
        'Path to settings file (absolute path recommended). Leave empty '
        'for default',
        'database-path':
        'Path to sqlite database (absolute path recommended). Leave empty '
        'for default',
        'address':
...
@task(
    help={
        ...
        'default',
        'database-path':
        'Path to sqlite database (absolute path recommended). Leave empty for '
        'default',
        'database-type':
        'Database type to use. Supported: sqlite3, postgresql. Default: '
        'sqlite3',
        'key-length':
