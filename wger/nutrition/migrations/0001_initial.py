    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('license_author',
                 models.CharField(
                     help_text='If you are not the author, enter the '
                     'name or source here. This is needed for some licenses'
                     ' e.g. the CC-BY-SA.',
                     max_length=50,
                     null=True,
                     verbose_name='Author',
            ...
            fields=[
                ...
                ('has_goal_calories',
                 models.BooleanField(
                     ...
                     'plan as having a goal amount of calories. You can use '
                     'the calculator or enter the value yourself.',
