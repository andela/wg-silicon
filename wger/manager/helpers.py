        ...
        for exercise in set['exercise_list']:
            ...
            if images:
                if exercise['obj'].main_image:
                    ...
                    # Make the images somewhat larger when printing only the wo
                    # rkout and not also the columns for weight logs
                    if only_table:
                        image_size = 2
                    else:
                        image_size = 1.5
...
def reps_smart_text(settings, set_obj):
    ...
    a repetition nd weight units as appropriate, e.g. "8 x 2 Plates",
    "10, 20, 30, ∞"
    ...
    return setting_text, \
        setting_list, weight_list, reps_list, repetition_units, weight_units
