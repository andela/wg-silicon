        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show_english_ingredients',
                 models.BooleanField(
                     default=True,
                     help_text='Check to also show ingredients in '
                     'English while creating\na nutritional plan. '
                     'These ingredients are extracted from a list provided\n'
                     'by the US Department of Agriculture. It is extremely '
                     'complete, with around\n7000 entries, but can be '
                     'somewhat overwhelming and make the search difficult.',
                     verbose_name='Also use ingredients in English')),
                ('workout_reminder_active',
                 models.BooleanField(
                     default=False,
                     help_text='Check to activate automatic reminders '
                     'for workouts. You need to provide a valid email '
                     'for this to work.',
                ...
                ('timer_pause',
                 models.IntegerField(
                     default=90,
                     help_text='Default duration in seconds of pauses '
                     'used by the timer in the gym mode.',
                ...
                ('notification_language',
                 models.ForeignKey(
                     ...
                     'This does not affect then language used on the '
                     'website.'
                 )),
                ('user',
